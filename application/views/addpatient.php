                            ...
                            <form name="addpatient" id="addpatient" method="post" action="<?php echo base_url('user_operation/addpatient'); ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Pincode</label>
                                            <input type="text" class="form-control" name="pin" placeholder="pin code" required="" maxlength="10">
                                            <?php if($error['pin']){?> <span class="text-danger"><?php echo $error['pin']; ?></span> <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
